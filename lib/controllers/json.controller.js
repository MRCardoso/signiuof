...
exports.signup = function(req,res)
{
    ...
    user.save((err, u) => {
        if (err){
            ...
            return res.redirect(_configure._routes.signup);
        }
 ...
 * success: set flash with succes message and redirect to_configure._routes.signin
 * fail: set flash with errors and redirect to _configure._routes.forgot 
 * @param {Object} req the object with request information(input)
 * @param {Object} res the object with response information(output)
 * @param {*} next
 */
exports.forgotPassword = function(req, res, next)
{
    if( req.body.email != null && req.body.email != '' )
    {
        User.findOne({email: req.body.email}, function(err, user)
        {
            if(err) {
                ...
                return res.redirect(_configure._routes.forgot);
            }
            else if (!user) {
                ...
                user.save(function(err) 
                {
                    ...
                    help.sendMail({
                        ...
                        res.redirect(_configure._routes.signin);
                    }, _configure);                    
                });                
            }            
        })
    ...
    else
    {
        ...
        res.redirect(_configure._routes.forgot);
    }
};
