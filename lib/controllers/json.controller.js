...
exports.signup = function(req,res)
{
    ...
    user.save((err, u) => {
        if (err){
            ...
            return res.redirect(this.getConfig()._routes.signup);
        }
 ...
 * success: set flash with succes message and redirect tothis.getConfig()._routes.signin
 * fail: set flash with errors and redirect to this.getConfig()._routes.forgot 
 * @param {Object} req the object with request information(input)
 * @param {Object} res the object with response information(output)
 * @param {*} next
 */
exports.forgotPassword = function(req, res, next)
{
    if( req.body.email != null && req.body.email != '' )
    {
        User.findOne({email: req.body.email}, function(err, user)
        {
            if(err) {
                ...
                return res.redirect(this.getConfig()._routes.forgot);
            }
            else if (!user) {
                ...
                user.save(function(err) 
                {
                    ...
                    help.sendMail({
                        ...
                        res.redirect(this.getConfig()._routes.signin);
                    }, this.getConfig());                    
                });                
            }            
        })
    ...
    else
    {
        ...
        res.redirect(this.getConfig()._routes.forgot);
    }
};
